...
class NewOrganizationAccount extends StatefulWidget {
  NewOrganizationAccount({Key? key}) : super(key: key);

  @override
  State<NewOrganizationAccount> createState() => _NewOrganizationAccountState();
}

class _NewOrganizationAccountState extends State<NewOrganizationAccount> {
